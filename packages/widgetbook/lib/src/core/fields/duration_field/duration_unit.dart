...
/// through, used by the duration field to decide which inputs to display.
///
...
enum DurationUnit {
  ...
  /// The units shown by default: hours, minutes, seconds and milliseconds.
  static const Set<DurationUnit> defaults = {
    hours,
    minutes,
    seconds,
    milliseconds,
