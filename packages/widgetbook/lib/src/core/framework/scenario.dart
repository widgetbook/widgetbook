...
enum ScenarioType {
  ...
  // Generated by crossing a ScenarioDefinition with a base scenario,
  // see ScenarioStrategy
  crossed,
}
...
class Scenario<TWidget extends Widget, TArgs extends StoryArgs<TWidget>>
  ...
  /// Creates a crossed variant of this scenario for the given [definition]:
  /// it keeps this scenario's args and [run] callback, and merges the
  /// definition's modes beneath this scenario's modes (this scenario's
  /// modes win). The story's modes are merged last via the [modes] getter.
  @internal
  Scenario<TWidget, TArgs> crossWith(
    ScenarioDefinition definition,
    String name,
  ) {
    return Scenario<TWidget, TArgs>(
      type: ScenarioType.crossed,
      name: name,
      modes: _modes == null
          ? definition.modes
