...
- **FEAT**: Support named constructors in code generation via `Meta(constructor: Widget.named)`. ([#1899](https://github.com/widgetbook/widgetbook/pull/1899))
...
- **REFACTOR**: Use named prefixes for generated `components.g.dart` imports. ([#1813](https://github.com/widgetbook/widgetbook/pull/1813))
...
- **FEAT**: Create default `Scenario` when none are provided. ([#1775](https://github.com/widgetbook/widgetbook/pull/1775))
- **FIX**: Show scenarios in the navigation tree. ([#1774](https://github.com/widgetbook/widgetbook/pull/1774))
...
- **BREAKING**: Rename `Addon.buildUseCase` to `Addon.apply`. ([#1743](https://github.com/widgetbook/widgetbook/pull/1743))
- **BREAKING**: Remove leaf components feature. ([#1745](https://github.com/widgetbook/widgetbook/pull/1745))
