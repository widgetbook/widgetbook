...
- **FIX**: Fix inconsistent background color of the workbench and device add-on. ([#1461](https://github.com/widgetbook/widgetbook/pull/1461) - by [@ValentinVignal](https://github.com/ValentinVignal)).
