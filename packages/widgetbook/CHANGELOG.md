...
- **FEAT**: Add `scenariosViewport` field to `Story`; to allow specifying default viewport for all scenarios in the story. ([#1626](https://github.com/widgetbook/widgetbook/pull/1626))
