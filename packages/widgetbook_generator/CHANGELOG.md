...
- **FEAT**: Generate `_Defaults` for default `setup` and `builder`. ([#1768](https://github.com/widgetbook/widgetbook/pull/1768))
...
- **FEAT**: Use widget's doc comments as default `docs` for components. ([#1746](https://github.com/widgetbook/widgetbook/pull/1746))
