...
abstract class $PackageCopyWith<$Res> {
  ...
  $Res call({String projectName, String path, PackageType type});
}
...
class _$_Package implements _Package {
  _$_Package(
      {required this.projectName, required this.path, required this.type});
  ...
  @override
  String toString() {
    return 'Package(projectName: $projectName, path: $path, type: $type)';
  }
