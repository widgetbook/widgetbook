...
```url
https://widgetbook.acme.com/#/?path=my/story/path/default&preview
```
...
```url
# Args panel only
https://widgetbook.acme.com/#/?path=my/story/path/default&panels=args
```

```url
# Args and Addons panels
https://widgetbook.acme.com/#/?path=my/story/path/default&panels=args,addons
```

```url
# Navigation panel only
https://widgetbook.acme.com/#/?path=my/story/path/default&panels=navigation
```
