...
To catalog the `HomePage` widget, you need to provide the `UserProvider` with a [mock implementation](/guides/mocking#approach-ii-mocking-libraries) or by using [property extraction](/guides/mocking#approach-i-extraction).