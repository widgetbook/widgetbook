...
DocBlocks are Flutter widgets. Inside `build(context)`, you have full access to the widget tree, so you can style them however you like.

### Using Your App Theme

If you use the [Theme Addon](/addons/theme-addon), your app's theme is available in the widget tree. Custom DocBlocks can read it the same way your app widgets do.
...
Since the DocBlocks read directly from your theme, they stay in sync with your app's design tokens. If you change a color or font in your theme, the docs update automatically.
