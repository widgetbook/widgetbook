...
<Info>
To catch accessibility *regressions* across a pull request — not just inspect the tree while developing — see [Accessibility Regression Testing](/cloud/accessibility/overview) in Widgetbook Cloud.
</Info>
