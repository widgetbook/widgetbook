...
These characteristics of Fields make them flexible tools for configuring settings within
the Addons and communicating data across different parts of the system.
...
Addon.[Read more here](/Addons/custom-addon).
