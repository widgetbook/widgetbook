...
1. Wrap all stories with a custom widget.
...
If you are using [`flutter_screenutil`](https://pub.dev/packages/flutter_screenutil) package, you can use the `BuilderAddon` to wrap your stories with `ScreenUtilInit` widget.
...
To use this addon for [testing](/testing), you can enable the `BuilderMode` in your stories:
