...
The `LocalizationAddon` is supported in the [Multi Snapshot Reviews](/cloud/reviews/multi-snapshot) via the `LocalizationAddonConfig`. Here's how to configure it:
