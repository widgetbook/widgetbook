...
Due to knobs, users of Widgetbook can change parameters of a use-case to test different inputs and states.
Changing parameters helps developers and designers to better understand the functionality of a component.
...
The `context` parameter provides access to the add-on properties as descriped [here](/add-ons/overview).
