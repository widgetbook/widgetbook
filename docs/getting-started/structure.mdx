...
Let's take a look at a typical Flutter example.
In this case, you may add a `components` or `widgets` folder to your projects where you can manage your UI catalog's structure.
...
>
  <TabItem value="generator">
   The generator creates the navigation tree based on the component's file location specified for the `type` parameter of the `@WidgetbookUseCase` annotation. 
