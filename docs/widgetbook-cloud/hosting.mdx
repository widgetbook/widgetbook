...
1. An API key is required to publish a build. See [How to Create an API Key](/widgetbook-cloud/setup#How-to-Create-an-API-Key) for more information.
1. Run `widgetbook publish --api-key YOUR-API-KEY`

An API key is required to publish a build. See [How to Create an API Key](/widgetbook-cloud/setup#How-to-Create-an-API-Key) for more information.
