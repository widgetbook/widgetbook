...
| Owner | Has all the rights of a member and can fetch API keys, delete the project and upgrade, downgrate, add and delete other users. |
...
Follow the user interface to make adjustments to both these lists.

An owner might add a user via email address which has not yet registered for Widgetbook Cloud.
