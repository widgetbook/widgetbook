...
To create a new project, you need a [billing account](/widgetbook-cloud/billing/#create-a-billing-account), and the user creating the project must be the billing account owner. Follow the steps provided by the user interface to create a project.
...
Project owners can add and remove users from the project. To modify user access, click the _View details_ button to see the list of members and owners. Follow the user interface instructions to adjust these lists.
...
Please note that adding users may affect your Stripe billing charges. For more information on user billing, see [Invoicing](/widgetbook-cloud/billing/#Invoicing).
