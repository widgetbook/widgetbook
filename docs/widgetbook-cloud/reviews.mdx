...
<Warning>
  Widgetbook Cloud Review currently still doesn't work with Bitbucket.
  We are working to support it very soon.
</Warning>
...
1. [**Multi Mode Snapshots**](/widgetbook-cloud/reviews#multi-snapshot-reviews): to automatically detect UI regressions for different addon and knob configurations.
1. [**Structured Review Process**](/widgetbook-cloud/reviews#structured-review-process): to ensure that all UI changes are intentional and match the design expectations.
...
## Tutorial video
Watch the [Reviews tutorial video](https://youtu.be/CalXXyThDi4?feature=shared).

## Pre-requisites

1. **Connect** your Widgetbook Project to a git repository from the project settings page.
1. Make sure you have a [Widgetbook Build](/widgetbook-cloud/builds) on pushes of new commits [via CI](/widgetbook-cloud/builds#pushing-new-builds-with-ci) (e.g. GitHub Actions).
...
Find more information in the dedicated [Multi Snapshot Reviews page](/widgetbook-cloud/multi-snapshot).
{/* TODO (Youssef) it is weird that we have a separate page for that. But I don't want to make this page super long. Any ideas? */}
...
#### Best Practices
Our customer 1Komma5º explains how they are using Widgetbook Cloud's Review feature in their development process. They report that every designer and developer working with Widgetbook Cloud saves 20% of their time. Watch the [recording of their Widgetbook talk](https://youtu.be/Du5yVtnmNzg?feature=shared).
