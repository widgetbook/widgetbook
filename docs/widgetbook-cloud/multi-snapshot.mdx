...
{/* TODO (Youssef) include image of Multi-Snapshot Reviews. Please ask Benita for the image she has been using */}
...
1. Choose the addons you like to test and include them, e.g. Themes and Languages. Here are the available `AddonConfig` classes:
   ...
   - `ZoomAddonConfig`
1. Add the configurations matrix to the `cloudAddonsConfigs` parameter of the `@App` annotation. In this example, we’d like to test German in dark mode but English in light mode.
