...
You'll be logged in, once the signup completes.
...
If you use password recovery, please be aware that the password recovery link is invalidated after a few hours due to security reasons.
...
On instruction how to host a Widgetbook in Widgetbook Cloud see [Hosting](/widgetbook-cloud/hosting).