...
## Step 5: Configure GitHub App (Optional)

1. Initiate via your Company Profile
2. Select your Company
3. Start GitHub App Installation Flow
4. Link to a Project, Connect your Repository and Sync Reviews with Pull Requests
