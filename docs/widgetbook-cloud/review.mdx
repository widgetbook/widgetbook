...
The structure of a review has similarities with how pull requests work.
...
>
  ...
  <TabItem value="feature">
    ...
    <Note>To successfully upload review information you must define the `--base-branch` argument for the Widgetbook CLI.</Note>
    ...
    Please have a look at our [CI/CD provider examples](/widgetbook-cloud/hosting#examples).</Note> 
  </TabItem>
</Tabs>
