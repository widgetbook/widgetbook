...
Therefore, for each pull request the Widgetbook Cloud solution created a Review that corresponds to a pull request in your Git provider.
...
<Warning>
    ...
    That means, that already existing use-cases will not be shown.
</Warning>
