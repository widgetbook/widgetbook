...
For each Pull-Request, our CLI analyzes the changes to your Widgetbook and creates a review.
...
- Use the CLI from the [widgetbook_cli package](https://pub.dev/packages/widgetbook_cli).
- Setup a GitHub app
