...
If the button is pressed, the application forwards to the Stripe customer portal which allows to view recent payments and manage the subscription.
...
Let's assume the following project structure with it's members:
