...
<Steps>
  ...
  <Step title="Add API Key as a Variable">
    ...
    The key is shown only once, so add it as `WIDGETBOOK_API_KEY` to your [Bitbucket's Pipeline Variables](https://support.atlassian.com/bitbucket-cloud/docs/variables-and-secrets/#User-defined-variables) right away.
