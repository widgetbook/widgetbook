...
Widgetbook Cloud links builds to [Azure commit statuses](https://learn.microsoft.com/en-us/rest/api/azure/devops/git/statuses) so accessing Widgetbook builds integrates seamingless with your Azure workflow.
