...
<Info>
  Setting up designers as required reviewers? See
  [When to involve a designer](/cloud/for-designers/when-to-involve-a-designer)
  for choosing between requiring design approval on every pull request and leaving
  it to the developer to request one.
</Info>
