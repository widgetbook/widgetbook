...
<Info>
  Setting up designers as required reviewers?
  See [Decide when to review](/cloud/for-designers/when-to-involve-a-designer) for choosing between requiring design approval on every pull request and leaving the choice to the developer.
</Info>
