...
<Info>
  Designers: see [Working with Figma](/cloud/for-designers/figma) for how to use
  the "View in Figma" button during a review and what you can do in Figma to make
  the comparison faster and more reliable.
</Info>
