...
<Info>
  Designers: see [Compare against Figma](/cloud/for-designers/figma) for using the View in Figma button and setting designs up so the comparison stays reliable.
</Info>
