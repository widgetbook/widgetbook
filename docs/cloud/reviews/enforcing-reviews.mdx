...
<Steps>
  ...
  <Step title="Open the ruleset page">
    ...
    <Step title="Create new branch ruleset">
    By clicking the *New ruleset* dropdown button create a new branch ruleset.

    <Image src="/assets/cloud/reviews/enforcing-reviews/create-new-ruleset.png" />
  </Step>
</Steps>