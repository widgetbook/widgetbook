...
A review is the sign-off surface on a [visual pull request](/cloud/visual-pull-request/overview). Reviewers inspect the changed scenarios in a browser, comment on them, and approve or request changes. The decision is reported back to your Git provider as a commit status.
...
2. Widgetbook Cloud creates the review automatically and posts its URL as a commit status.
...
5. Requested changes block the merge until they are addressed. This can be disabled in the project settings.
...
## Get More out of a Review

<CardGroup>
  <Card title="Figma Reviews" icon="figma fa-brands" href="/cloud/reviews/figma">
    Link a story to its Figma component and compare implementation against design.
  </Card>

  <Card title="Required reviewers" icon="user-shield" href="/cloud/reviews/required-reviewer">
    Require a lead or designer to approve before a merge is allowed.
  </Card>

  <Card title="Notifications" icon="bell" href="/cloud/reviews/notifications/slack">
    Email and Slack alerts so reviews do not sit unnoticed.
  </Card>

  <Card title="For Designers" icon="pen-ruler" href="/cloud/for-designers/overview">
    A designer-facing guide to reviewing UI changes.
  </Card>
</CardGroup>
