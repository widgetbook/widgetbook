...
1. [**Accessibility Regression Testing**](/cloud/accessibility/overview): Catch changes to the accessibility tree — missing labels, changed roles, reordered nodes — that a visual review cannot see.