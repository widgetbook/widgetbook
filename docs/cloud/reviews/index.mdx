...
Widgetbook Cloud Reviews not just helps you introduce a **"Design Review"** in your workflow, but also helps you to **detect UI regressions automatically**. It provides a structured review process to ensure that all **UI changes are intentional** and match the design expectations.
...
| **Reviewer**   | Developers                                         | Designers and Developers                                                 |
...
1. Designers and Developers should review the visual differences _(if any)_, and either **approve** the changes or **request changes**.
