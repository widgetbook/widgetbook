...
From the `name` parameter, the generator will create the [`AppInfo`](/widgetbook/properties#appinfo) property of [package:widgetbook](/widgetbook/overview). Therefore, this value will show in the upper left corner of the Widgetbook. 
