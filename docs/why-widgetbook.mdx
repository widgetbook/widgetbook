...
Widgetbook addresses these challenges by providing an open source Storybook for Flutter as well as Widgetbook Cloud. We've been featured as experts for design systems and designer/developer collaboration by Google's Flutter team. Feel free to watch [Google's demo video of Widgetbook](https://youtu.be/-g2KYjiPzzA?feature=shared).
...
Watch how our customers create their own design systems with Widgetbook:
  - 1Komma5º creates an in-house design system which is used accross 6 different projects. [Watch their presentation](https://youtu.be/Du5yVtnmNzg?feature=shared&t=1319).
  - LeanCode is a software agency which creates a design system template that they share with every new client for the project start. [Watch their presentation](https://youtu.be/Du5yVtnmNzg?feature=shared&t=1803).

- **Build your widgets in isolation:** Implement widgets without needing to fuss with data, APIs, or business logic. Use Widgetbook's [Addons](/addons/overview) and [Knobs](/knobs/overview) to quickly test your widgets in all relevant configurations. Watch how our customer Lotum speeds up their app development by building their widgets in isolation with Widgetbook. [Watch their presentation](https://youtu.be/Du5yVtnmNzg?feature=shared&t=868).

- **Automated Golden Tests:** Widgetbook Cloud automatically detects all visual changes of your PR. Every widget can automatically be tested in different configurations, like themes or locales. Watch a [demo video](https://youtu.be/gCTSc99V-KI?feature=shared).
...
Watch a [demo video](https://youtu.be/gCTSc99V-KI?feature=shared).
