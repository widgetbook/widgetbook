...
<iframe
  id="testimonialto-widgetbook-tag-all-light"
  src="https://embed-v2.testimonial.to/w/widgetbook?theme=light&card=base&loadMore=on&initialCount=20&tag=all"
  frameborder="0"
  scrolling="no"
  width="100%"
></iframe>
<script
  ...
  dangerouslySetInnerHTML={{
    __html: `iFrameResize({log: false, checkOrigin: false}, '#testimonialto-widgetbook-tag-all-light');`,
  }}
></script>
