...
Your [design system](https://www.widgetbook.io/blog/building-and-maintaining-high-quality-flutter-uis-with-a-design-system) will usually have multiple components, and each component will have multiple stories. For example, a button component might have stories for different states like `Primary`, `Secondary`, `Disabled` etc.
