...
When the agent gets something wrong (usually because of a custom convention), **fix that one case manually**. Then re-run the agent with the corrected example included — it now knows exactly what to do for the remaining cases.
