...
Add-ons are a fully customizable way of configuring Widgetbook with changeable properties.
Developers can use the existing Add-ons or define their own custom Add-ons.

<Info>
    This section describes Add-ons in general.
    As every Add-on works a bit differently, make sure to also read into the documentation of the Add-on implementation that you are using for your Widgetbook.
</Info>
...
- [Text Scale Addon](/add-ons/text-scale-addon) for different test scales and accessibility
...
>
  <TabItem value="generator">
    ...
    See the corresponding documentation for each Add-on for more information.
  </TabItem>
