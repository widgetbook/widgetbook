...
- **Easily test your widgets** in different **states** (e.g. error, loading, etc.) via [Args](/args), and **configurations** (e.g. dark mode, different locales, etc.) via [Addons](/addons/overview).
