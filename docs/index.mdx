...
Widgetbook is a Flutter package inspired by Storybook.js that simplifies the process of cataloging widgets to create your own [design system](/glossary/design-system), and testing the widgets across various configurations, like different devices, languages and themes.
...
- **Collaborate between designers and developers:** Share your Widgetbook with your design team via [Widgetbook Cloud Reviews](/cloud/reviews) to ensure that the implementation matches the design.
