...
- **Generator Approach:** A method for configuring Widgetbook that uses the widgetbook_generator and widgetbook_annotation packages to automatically synchronize the widget structure in Widgetbook with your application.

- **Manual Approach:** A method for configuring Widgetbook that involves manually maintaining the widget structure in Widgetbook to keep it in sync with your application.
