...
We completely rethought Widgetbook from the ground up. This release is focused on creating a solid base that we can build more features onto, with [Widgetbook Cloud](/widgetbook-cloud/overview) in mind.
