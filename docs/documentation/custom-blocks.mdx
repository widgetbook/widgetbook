...
See the [Customize](/documentation/customize) guide for detailed instructions on how to configure the documentation builder.
...
To style your custom blocks with your app's design system, see [Styling Documentation](/documentation/styling).
